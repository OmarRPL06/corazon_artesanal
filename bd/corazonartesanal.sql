...
-- Volcando estructura de base de datos para corazonartesanal
CREATE DATABASE IF NOT EXISTS `corazonartesanal` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `corazonartesanal`;

-- Volcando estructura para tabla corazonartesanal.clientes
...
-- Volcando datos para la tabla corazonartesanal.clientes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;

-- Volcando estructura para tabla corazonartesanal.failed_jobs
...
-- Volcando datos para la tabla corazonartesanal.failed_jobs: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Volcando estructura para tabla corazonartesanal.migrations
...
-- Volcando datos para la tabla corazonartesanal.migrations: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla corazonartesanal.password_resets
...
-- Volcando datos para la tabla corazonartesanal.password_resets: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Volcando estructura para tabla corazonartesanal.personal_access_tokens
...
-- Volcando datos para la tabla corazonartesanal.personal_access_tokens: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `personal_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_access_tokens` ENABLE KEYS */;

-- Volcando estructura para tabla corazonartesanal.productos
...
-- Volcando datos para la tabla corazonartesanal.productos: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla corazonartesanal.users
...
-- Volcando datos para la tabla corazonartesanal.users: ~1 rows (aproximadamente)
...
INSERT IGNORE INTO `users` (`id`, `name`, `apellidoPaterno`, `apellidoMaterno`, `telefono`, `email`, `user`, `password`, `tipo`, `email_verified_at`, `remember_token`, `api_token`, `created_at`, `updated_at`) VALUES
	(2, 'Omar Rene', 'Perez', 'Lopez', '9191735421', 'admin@gmail.com', 'Administrador', '$2y$10$KW7StiFrPujeHlZ0JFf74uVK9h3NOdu8w2pspEN61j/O4kOHW.Vji', 'ADMIN', '2022-08-19 03:19:02', 'HYvguVdsmEY7b15QGxIxTVJ783CdwcpX8DJK0NPSI58iXSfe0uFBJIiOIPNl', '438b1f3145fb1cdc68711edf1f01e16a49488dc8fd867481f9cb1b80c5869102', '2022-08-18 17:15:36', '2022-08-19 01:46:47');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Volcando estructura para tabla corazonartesanal.users_old
...
-- Volcando datos para la tabla corazonartesanal.users_old: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla corazonartesanal.ventas
...
-- Volcando datos para la tabla corazonartesanal.ventas: ~0 rows (aproximadamente)
