...
-- Volcando datos para la tabla corazonartesanal.migrations: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla corazonartesanal.users: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT IGNORE INTO `users` (`idUser`, `nombre`, `apellido_Paterno`, `apellido_Materno`, `telefono`, `email`, `password`, `user`, `tipo`, `created_at`, `update_at`, `remember_token`) VALUES
