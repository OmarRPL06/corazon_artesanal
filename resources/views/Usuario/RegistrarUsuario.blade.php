    ...
    <div class="container-card">
        <div class="card">
            ...
            <div class="container-form">
                <form class="row g-4 font-sans-serif-orpl" action="{{route('usuario.RegistrarUser')}}" method="POST">
                    @csrf
                    @if (count($errors) > 0)
                    ...
                    <div class="col-sm-12">
                        <center>
                            <button type="submit" class="btn btn-success btn-sm text-white">Registrar datos</button>
                            <a href="{{ route('usuario.login') }}" type="submit" class="btn btn-danger btn-sm text-white">Ya tengo Cuenta</a>
                        </center>
                    </div>
                </form>
            </div>
