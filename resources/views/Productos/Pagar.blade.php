            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active">Pagar Cuenta</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-12">
                <div class="checkout-form">
                    <h2>Realiza tu pago aqui</h2>
                    <p>Por favor registra tus datos faltantes</p>
                    <!-- Form -->
                    <form class="form" method="post" action="#">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Numero de teléfono<span>*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Referencias:<span>*</span></label>
                                    <input type="text" name="address" placeholder="" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
            ...
            <div class="col-lg-4 col-12">
                <div class="order-details">
                    ...
                    <div class="single-widget">
                        ...
                        <div class="content">
                            <ul>
                                ...
                                <li class="last">Total<span>$430.00</span></li>
                            </ul>
                        </div>
                    </div>
                    <!--/ End Order Widget -->
                    ...
                    <div class="single-widget">
                        <h2>PAGAR</h2>
                        <div class="padding-left-30 padding-top-20">
                    ...
                    <div class="single-widget payement">
                        <div class="content">
                            <img src="/ecommerce/images/payment-method.png" alt="#">
                        </div>
                    </div>
