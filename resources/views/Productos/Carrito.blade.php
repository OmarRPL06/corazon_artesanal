        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table shopping-summery">
                    ...
                    <tbody>
                        <tr>
                            <td class="image" data-title="No"><img src="/ecommerce/images/100x100.png" alt="#">
                            </td>
                            <td class="product-des" data-title="Description">
                                <p class="product-name"><a href="#">Vestido de mujer</a></p>
                                <p class="product-des">Vestido artesanal de muejer para todo hecho con calidad</p>
                            </td>
                ...
                <div class="total-amount">
                    <div class="row">
                            ...
                            <div class="left">
                                <div class="coupon">
                                    {{-- <form action="#" target="_blank">
                                        <input name="Coupon" placeholder="Agregar cupón">
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                <ul>
                                    <li>Subtotal del carrito<span>$330.00</span></li>
                                    <li>Envío<span>$100.00</span></li>
                                    <li>Ahorro<span>$00.00</span></li>
                                    <li class="last">Total a pagar<span>$310.00</span></li>
                                </ul>
                                <div class="button5">
                                    <a href="{{ url('/pagar/producto') }}" class="btn">Pagar Cuenta</a>
                                    <a href="{{ url('/') }}" class="btn">Seguir Comprando</a>
                                </div>
                            </div>
                        </div>
                    </div>
